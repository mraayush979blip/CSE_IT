...
export const AdminDashboard: React.FC = () => {
  ...
  const tabs = ['students', 'faculty', 'monitor', 'reports', 'system'];
  const { activeTab, handleTabClick, goBack } = useParallelRouting('admin', tabs);
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-end border-b border-slate-300 pb-1">
        <div className="flex items-center space-x-2">
          <button
            onClick={goBack}
            className="p-2 -ml-1 text-slate-400 hover:text-indigo-600 hover:bg-slate-100 rounded-lg transition-all"
            title="Go Back"
          >
