    ...
    <div className="space-y-6">
      <div className="flex justify-between items-end border-b border-slate-300 pb-1">
        <div className="flex space-x-2">
          ...
          <button
            onClick={() => navigate('/admin/faculty', { replace: true })}
          ...
          <button
            onClick={() => navigate('/admin/monitor', { replace: true })}
          ...
          <button
            onClick={() => navigate('/admin/reports', { replace: true })}
          ...
          <button
            onClick={() => navigate('/admin/system', { replace: true })}
    ...
    <Card>
      ...
      <div className="flex items-center text-sm mb-6 text-slate-500 flex-wrap justify-between">
        <div className="flex items-center">
          <span className={`cursor-pointer hover:text-indigo-600 ${level === 'branches' ? 'font-bold text-indigo-600' : ''}`} onClick={() => navigate('/admin/students', { replace: true })}>Classes</span>
          {selBranch && <><ChevronRight className="h-4 w-4 mx-2" /><span className={`cursor-pointer hover:text-indigo-600 ${level === 'batches' ? 'font-bold text-indigo-600' : ''}`} onClick={() => navigate(`/admin/students/${branchId}`, { replace: true })}>{selBranch.name}</span></>}
...
const FacultyManagement: React.FC = () => {
  ...
  const setActiveSubTab = (tab: string) => navigate(`/admin/faculty/${tab}`, { replace: true });
